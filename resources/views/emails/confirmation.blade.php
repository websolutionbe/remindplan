...
<body  style="margin-top: 0; margin-bottom: 0; padding-top: 0; padding-bottom: 0; width: 100%; -webkit-text-size-adjust: 100%; -ms-text-size-adjust: 100%;" bgcolor="#F7FAFD">
    ...
    <tr><!-- Outer Table -->
        <td align="center"  bgcolor="#f0f0f0" data-composer>
            ...
            <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation" width="100%" style="width:100%;max-width:100%;" >
                <!-- lotus-header-2 -->
                <tr>
                    <td align="center"  bgcolor="#274384" class="container-padding">
...
{{--                                                            <img style="width:72px;border:0px;display: inline!important;" src="{{ public_path('./images/logo.png') }}" width="72" border="0" alt="hallo">--}}
                            ...
                            <tr  >
                                <td align="center" class="center-text">
                                    <img style="width:190px;border:0px;display: inline!important;" src="{{ $message->embed(public_path() . '/images/logo.png') }}" width="190" border="0"       alt="intro">
                                </td>
                            </tr>
                            <tr  >
                            ...
                            <tr  >
                                <td class="center-text"  align="center" style="font-family:'Figtree',Arial,Helvetica,sans-serif;font-size:24px;line-height:20px;font-weight:500;font-style:normal;color:#fff;text-decoration:none;letter-spacing:0px;">

                                    <div>
                                        {{ __t('email.confirmation.email-heading') }}
                                    </div>

                                </td>
                            </tr>
                            <tr  >
                                <td class="center-text" height="80"  align="center" style="font-family:'Figtree',Arial,Helvetica,sans-serif;font-size:16px;line-height:20px;font-weight:400;font-style:normal;color:#fff;text-decoration:none;letter-spacing:0px;">

                                    <div>
                                        {{ __t('email.confirmation.email-paragraph') }}
                                    </div>
            ...
            <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation" width="100%" style="width:100%;max-width:100%;" >
                <!-- lotus-footer-2 -->
                <tr>
                    <td align="center"  bgcolor="#F7FAFD" class="container-padding">
                        ...
                        <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation" class="row" width="580" style="width:580px;max-width:580px;">
                            ...
                            <tr  >
                                <td class="center-text"  align="center" style="font-family:'Figtree',Arial,Helvetica,sans-serif;font-size:14px;line-height:24px;font-weight:400;font-style:normal;color:#6e6e6e;text-decoration:none;letter-spacing:0px;">
                                    <span><a href="https://wittelach.be">wittelach.be</a></span>
                                </td>
                            </tr>
                        </table>
                        <!-- Content -->
